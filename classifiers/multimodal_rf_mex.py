#!/usr/bin/env python3
"""
Train a multimodal Random Forest empathy classifier on:
...
def parse_args() -> argparse.Namespace:
    ...
    default_out = os.path.join(script_dir, "PBC4emp", "results", "multimodal_rf_mex")

    parser = argparse.ArgumentParser(description="Train multimodal Random Forest empathy classifier (0/1/2).")
    ...
    parser.add_argument("--max-depth", type=int, default=0, help="0 means no max depth.")
    parser.add_argument("--min-samples-split", type=int, default=2)
    parser.add_argument("--min-samples-leaf", type=int, default=1)
    parser.add_argument("--max-features", type=str, default="sqrt", choices=["sqrt", "log2", "none"])
...
def main() -> None:
    ...
    model_path = os.path.join(args.output_dir, "best_multimodal_rf_mex_%s.pkl" % feature_tag)
